...
def generate_detailed_pdf(score, risk_text, lang_code, user_selections):
    ...
    def draw_header(c, y_pos):
        ...
        c.drawString(40, height - 70, "Xu Consulting Group Corporation | Confidential Assessment")
    ...
    c.drawString(40, 30, "Generated by Streamlit • Xu Consulting Group Corporation")
...
# --- Main Content ---
st.title("🛡️ " + t['title'])
st.caption(f"**Xu Consulting Group Corporation** | {t['subtitle']}")
st.markdown("---")
